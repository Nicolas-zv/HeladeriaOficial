<x-app-layout>
    <div class="container mx-auto py-8 px-4">
        <div class="max-w-xl mx-auto bg-white dark:bg-slate-700 rounded-lg shadow p-6">
            <h2 class="text-xl font-bold mb-6 text-gray-900 dark:text-white">Editar rol</h2>
            ...
            <form action="{{ route('roles.update', $role) }}" method="POST">
                ...
                <div class="flex justify-end">
                    ...
                    <button type="submit" class="rounded-lg px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white">
                        Actualizar
                    </button>
                </div>
            </form>
