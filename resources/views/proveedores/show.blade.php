<x-app-layout>
    <div class="container mx-auto px-4 py-8 max-w-2xl">
        <h1 class="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">Editar Proveedor</h1>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-md border border-gray-200 dark:border-gray-700 p-6 shadow-sm">
            <form action="{{ route('proveedores.update', $proveedor) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input id="codigo" name="codigo" value="{{ old('codigo', $proveedor->codigo) }}" required
                ...
                <div class="mb-4">
                    ...
                    <input id="descripcion" name="descripcion" value="{{ old('descripcion', $proveedor->descripcion) }}"
                ...
                <div class="mb-4">
                    ...
                    <input id="ubicacion" name="ubicacion" value="{{ old('ubicacion', $proveedor->ubicacion) }}"
                        class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100">
                ...
                <div class="mb-4">
                    ...
                    <input id="telefono" name="telefono" value="{{ old('telefono', $proveedor->telefono) }}"
                        class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100">
