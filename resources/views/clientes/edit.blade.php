<x-app-layout>
    <div class="container mx-auto px-4 py-8 max-w-2xl">
        <h1 class="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">Editar Cliente</h1>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-md border border-gray-200 dark:border-gray-700 p-6 shadow-sm">
            <form action="{{ route('clientes.update', $cliente) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input id="codigo" name="codigo" value="{{ old('codigo', $cliente->codigo) }}" required
                ...
                <div class="mb-4">
                    ...
                    <input id="nombre" name="nombre" value="{{ old('nombre', $cliente->persona->nombre ?? '') }}" required
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <input id="carnet" name="carnet" value="{{ old('carnet', $cliente->persona->carnet ?? '') }}"
                            class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100">
                    ...
                    <div>
                        ...
                        <input id="telefono" name="telefono" value="{{ old('telefono', $cliente->persona->telefono ?? '') }}"
                            class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100">
