<x-app-layout>
    <div class="container mx-auto px-4 py-8 max-w-2xl">
        <h1 class="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">Crear Menú</h1>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-md border border-gray-200 dark:border-gray-700 p-6 shadow-sm">
            <form action="{{ route('menus.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input id="cod_menu" name="cod_menu" value="{{ old('cod_menu') }}" required
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                    <div>
                        ...
                        <input id="precio" name="precio" type="number" step="0.01" min="0" value="{{ old('precio', '0.00') }}" required
                    ...
                    <div>
                        ...
                        <input id="dia" name="dia" value="{{ old('dia') }}"
                            class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100">
                ...
                <div class="mb-4">
                    ...
                    <textarea id="descripcion" name="descripcion" rows="4" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100">{{ old('descripcion') }}</textarea>
